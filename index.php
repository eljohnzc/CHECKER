		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>SERZEX CHECKER</strong></h4>
					<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://t.me/Serzex_demon">CLICK HERE TO DM ME AND GIVE FEEDBACK </a> <br>
					<textarea rows="6" class="form-control text-center form-checker mb-2" placeholder="PUT YOUR CC HERE :>"></textarea>
					
	<br>	
<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://t.me/SERZEXChk">JOIN OUR COMMUNITY </a> <br>		
...
Swal.fire({ title: "SERZEX CHECKER", text: "WELCOME TO SERZEX CHECKER:(", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
